...
router.get('/', (req, res, next) => {
    ...
    */
    return gearController.getAllGear(req, res, next);
});

/**
 * GET a single gear by ID
 */
router.get('/:id', gearIdParamRules(), validate, (req, res, next) => {
    /*
        #swagger.tags = ['Gear']
        ...
        #swagger.responses[500] = { description: 'Internal server error' }
    */
    return gearController.getSingleGear(req, res, next);
});

/**
 * POST create a new gear
 */
router.post('/', authMiddleware, createGearRules(), validate, (req, res, next) => {
    /*
        #swagger.tags = ['Gear']
        ...
        #swagger.responses[500] = { description: 'Internal server error' }
    */
    return gearController.createGear(req, res, next);
});

/**
 * PUT update a gear by ID
 */
router.put('/:id', authMiddleware, gearIdParamRules(), updateGearRules(), validate, (req, res, next) => {
    /*
        #swagger.tags = ['Gear']
        ...
        #swagger.responses[500] = { description: 'Internal server error' }
    */
    return gearController.updateGear(req, res, next);
});

/**
 * DELETE a gear by ID
 */
router.delete('/:id', authMiddleware, gearIdParamRules(), validate, (req, res, next) => {
    /*
        #swagger.tags = ['Gear']
        ...
        #swagger.responses[500] = { description: 'Internal server error' }
    */
    return gearController.deleteGear(req, res, next);
});
