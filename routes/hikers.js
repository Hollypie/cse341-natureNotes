...
// #swagger.responses[500] = { description: 'Internal server error' }
router.post('/', authMiddleware, createHikerRules(), validate, hikersController.createHiker);
...
// #swagger.responses[422] = { description: 'Validation error' }
// #swagger.responses[500] = { description: 'Internal server error' }
router.put('/:id', authMiddleware, hikerIdParamRules(), updateHikerRules(), validate, hikersController.updateHiker);
...
// #swagger.responses[404] = { description: 'Hiker not found' }
// #swagger.responses[500] = { description: 'Internal server error' }
router.delete('/:id', authMiddleware, hikerIdParamRules(), validate, hikersController.deleteHiker);
